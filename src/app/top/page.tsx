  ...
  return (
    <div className="min-h-screen bg-[var(--background)]">
      <div className="max-w-[960px] mx-auto px-4 pt-2 pb-10">
        {/* タブ: 全編・ダイジェスト・項目別・説明資料（説明資料は資料一覧へ） */}
        ...
        {validTab === "full" && (() => {
          ...
          return (
            <section className="pt-0">
              <h3 className="text-white text-[14px] md:text-base tracking-[0.25em] uppercase text-center mb-2" style={{ fontWeight: 400 }}>FULL VIDEO</h3>
        ...
        {validTab === "digest" && (() => {
          ...
          return (
            <section className="pt-0">
              <h3 className="text-white text-[14px] md:text-base tracking-[0.25em] uppercase text-center mb-2" style={{ fontWeight: 400 }}>DIGEST VIDEO</h3>
              ...
              <section className="max-w-[560px] mx-auto text-center">
                <p className="text-white/90 text-sm md:text-base mb-4">続きは全編動画（約53分）で詳しくご説明しています。</p>
